    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    MailMessage m = new MailMessage(new MailAddress("shahidaafroj075@gmail.com", "User Registration- Email Confirmation"), new MailAddress(user.Email));
                    ...
                    smtp.Credentials = new NetworkCredential("shahidaafroj075@gmail.com", "gdtj wlnf oeug zaxg");
                    smtp.EnableSsl = true;
                    smtp.Send(m);
